...
def get_input_data_tensors(reader,
  ...
  with tf.name_scope("train_input"):
    files = gfile.Glob('gs://youtube8m-ml-us-east1/1/frame_level/train/train*.tfrecord') + gfile.Glob('gs://youtube8m-ml-us-east1/1/frame_level/validate/validate*.tfrecord')
    if not files:
